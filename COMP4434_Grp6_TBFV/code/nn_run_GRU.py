...
class GRUClassifier(nn.Module):
    """
    Basic GRU-based classifier for text data.
    """
    ...
    def forward(self, input_ids):
        ...
        # Use the mean of the GRU outputs for classification
...
def train_epoch(model, data_loader, loss_fn, optimizer, device, scheduler, n_examples):
    ...
    scheduler.step()  # Moved scheduler.step() outside the batch loop
...
def main():
    ...
    NUM_LABELS = 2
    DROPOUT = 0.3
    MODEL_NAME = 'GRUClassifier'  # Updated model name to reflect GRU
    ...
    # Initialize Model
    model = GRUClassifier(  # Changed to GRUClassifier
