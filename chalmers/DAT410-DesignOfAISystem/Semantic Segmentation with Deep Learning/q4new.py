...
train_folders = [
    'Potsdam-folds-step4/fold1',
    'Potsdam-folds-step4/fold2',
    'Potsdam-folds-step4/fold3'
]
...
val_dataset = PotsdamDataset('Potsdam-folds-step4/fold4', transform=transform)
test_dataset = PotsdamDataset('Potsdam-folds-step4/fold5', transform=transform)
